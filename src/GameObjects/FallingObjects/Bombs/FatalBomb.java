...
public final class FatalBomb extends FallingObjects {

    private SoundEffectPlayer fuseSoundPlayer;

    public FatalBomb() {
        super("resources/bombs/fatalBomb.png", FallingObjectType.fatalBomb);

        fuseSoundPlayer = new SoundEffectFactory().createSoundObj(SoundEffectType.fatalBombFuse);
    ...
    public FatalBomb(FallingRandomData fallingRandomData, double loadedTime) {
        super("resources/bombs/fatalBomb.png", FallingObjectType.fatalBomb);
